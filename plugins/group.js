...
// Command to set or disable goodbye messages
cmd({
    pattern: "goodbye",
...
// Command to set or disable welcome messages
cmd({
    pattern: "welcome",
